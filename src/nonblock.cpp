...
using namespace std;
typedef pair<const char*, const char*> range;

pair<const char*, const char*> parse_request(const char* request, int size);
        ...
        void *arg)
{
    ...
    range r = parse_request(req, strlen(req));
    string s(r.first, r.second);
...
pair<const char*, const char*> parse_request(const char* request, int size) {
    ...
    pair<const char*, const char*> range;
    range.first = request;
    while(*request != ' ') {
        ++request;
    }

    range.second = request;
